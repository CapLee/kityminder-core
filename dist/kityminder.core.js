/*!
 * ====================================================
 * Kity Minder Core - v1.4.50 - 2019-10-24
    ...
    value: function(require, exports, module) {
        ...
        kity.extendClass(Minder, {
            ...
            updateConnect: function(node) {
                ...
                var strokeColor = node.data.color || "white", strokeWidth = node.getStyle("connect-width") || 2;
        ...
        Module.register("PriorityModule", function() {
            ...
            var PriorityIcon = kity.createClass("PriorityIcon", {
                ...
                create: function(node) {
                    ...
                    number = new kity.Text().setX(this.width / 2 - 4).setY(this.height / 2).setTextAnchor("middle").setVerticalAlign("middle").setFontItalic(false).setFontSize(10).fill(this.strokeColor);
